        ...
        <div class="flex flex-col w-full bg-red mt-10 content-center align-middle justify-between px-2 mb-10">
            ...
            <div class="grid grid-cols-3 gap-3 mt-5">
                ...
                <div class="relative rounded overflow-hidden group">
                    ...
                    <a href="#"
                        class="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center text-xl text-white font-roboto font-medium group-hover:bg-opacity-60 transition">Prendas Electronícas</a>
                </div>
                <div class="relative rounded overflow-hidden group">
